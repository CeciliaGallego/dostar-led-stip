...
2. Copy de file "adafruit-circuitpython-raspberry_pi_pico-en_GB-9.2.8.uf2" to the drive that Raspberry drive. This will automatically close the window and reopen it with circuity loaded on the board.
